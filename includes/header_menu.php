...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand">Vending Machine</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Soft Drinks</a>
                                   <a href="products.php#shirt" class="dropdown-item">Fast Foods</a>
                                   <a href="products.php#shoes" class="dropdown-item">Cigarette</a>
                                   <a href="products.php#headphones" class="dropdown-item">Lottery</a>
                               </div>
